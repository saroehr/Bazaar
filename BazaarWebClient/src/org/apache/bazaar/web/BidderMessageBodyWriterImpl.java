...
public final class BidderMessageBodyWriterImpl implements VersionableMessageBodyWriter<Bidder> {
	 ...
	 */
	@Override
	public void writeTo(final Bidder object, final Class<?> clazz, final Type type, final Annotation[] annotations,
		...
		try (final BufferedWriter writer = new BufferedWriter(
			...
			jsonGenerator.write(JsonKeys.BIDDER, new BidderJsonWriterImpl().write(object));
