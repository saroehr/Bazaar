...
final class BazaarManagerImpl implements BazaarManager {
	...
	static {
		...
		BazaarManagerImpl.CLIENT_BUILDER.register(BazaarMessageBodyReaderImpl.class)
				.register(BazaarMessageBodyWriterImpl.class).register(BazaarCollectionMessageBodyReaderImpl.class)
				.register(BazaarCollectionMessageBodyWriterImpl.class).register(CategoryMessageBodyReaderImpl.class)
				.register(CategoryMessageBodyWriterImpl.class).register(CategoryCollectionMessageBodyReaderImpl.class)
				.register(CategoryCollectionMessageBodyWriterImpl.class).register(ItemMessageBodyReaderImpl.class)
				.register(ItemMessageBodyWriterImpl.class).register(ItemCollectionMessageBodyReaderImpl.class)
				.register(ItemCollectionMessageBodyWriterImpl.class).register(BidderMessageBodyReaderImpl.class)
				.register(BidderMessageBodyWriterImpl.class).register(BidderCollectionMessageBodyReaderImpl.class)
				.register(BidderCollectionMessageBodyWriterImpl.class).register(BidMessageBodyReaderImpl.class)
				.register(BidMessageBodyWriterImpl.class).register(BidCollectionMessageBodyReaderImpl.class)
				.register(BidCollectionMessageBodyWriterImpl.class).register(ThrowableMessageBodyReaderImpl.class)
				.register(ThrowableMessageBodyWriterImpl.class);
