...
public interface BazaarManager {
	...
	/**
	 * Factory method creates new Bazaar. End date must be beyond start date.
	 *
	...
	/**
	 * Factory method creates new Bazaar with reserve price End date must be
	 * beyond start date.
	 *
	 * @param item The item to be Bazaared
	 * @param startDate The Bazaar start date
	...
	/**
	 * Returns root category. The root category is the parent of all categories.
	 * It is the only category whose parent category is itself
	 *
	 ...
	 *
	 * @param identifier The identifier of category
	 ...
	 *
	 * @param name The name of categories to find
	 ...
	 *
	 * @param identifier The identifier of item to return
	 * @return The Item with identifier
	 * @throws ItemNotFoundException if no item with identifier exists
	 * @throws BazaarException if the operation could not be completed
	 */
	 ...
	 *
	 * @param name The name of items to find
	 * @return The unmodifiable set of all items with name or empty set if no
	 *         items with name found
	 * @throws BazaarException if the operation could not be completed
	 */
	 ...
	 * @return The unmodifiable set of all items with category or empty set if
	 *         no items with category found
	 * @throws BazaarException if the operation could not be completed
	 */
	 ...
	 *
	 * @return The unmodifiable set of all items or empty set if no items
	 * @throws BazaarException if the operation could not be completed
	 */
	 ...
	 *
	 * @param identifier The identifier of bidder to return
	 * @return The bidder with identifier
	 * @throws BidderNotFoundException if no bidder with identifier exists
	 * @throws BazaarException if the operation could not be completed
	 */
	 ...
	 *
	 * @param name The name of bidders to find
	 ...
	 * @throws BidNotFoundException if no bid with identifier exists
	 * @throws BazaarException if the operation could not be completed.
	 */
	 ...
	 * @return The unmodifiable set of all bids for bidder
	 * @throws BazaarException if the operation could not be completed
	 */
